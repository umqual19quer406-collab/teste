...
from app.infra.repositories.vendas.sc5_pedidos_query_repo import ( 
    sc5_pedidos_listar_tx, 
    sc5_pedidos_contar_tx, 
) 
 
def listar_pedidos_tx( 
    cur, 
    usuario: str, 
    filial: str | None, 
    status: str | None, 
    ...
    total = sc5_pedidos_contar_tx(cur, filial, status, origem, de, ate) 
    items = sc5_pedidos_listar_tx(cur, filial, status, origem, de, ate, limit, offset) 
